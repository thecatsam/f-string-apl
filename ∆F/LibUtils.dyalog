⍝ ∆FLibUtils.dyalog      (UPDATE_TIME: '2026-06-30') 
:Namespace libUtils
⍝ ===================================================================================
...
⍝ ∘ See FString for fn ⍙Load_LibAuto, which loads this library.
