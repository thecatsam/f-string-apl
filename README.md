...
| **argCache** | ***\[5\]*** | ***argCache: 1*** | <span class="red"><strong>If ***argCache: 1***,</strong></span> will look for a prior call to **∆F** with this ***fstring*** and these ***options*** and use the ***code*** generated previously. <span class="red"><strong>Otherwise, </strong></span> generates the required code on each call. |
